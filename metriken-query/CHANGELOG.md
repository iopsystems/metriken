...
- Add `CompositionSource::lazy` for deferred composition-source loading.
- Add `CompositionCatalog::series_count` so `total_series_count` on a composed
  `ParquetReader` does not load lazy children.
